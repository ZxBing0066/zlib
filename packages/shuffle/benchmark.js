...
const suiteList = [
    { name: 'Array shuffle', data: array, ignoreBm: ['z-shuffle fix'] },
    { name: 'String shuffle', data: string, ignoreBm: ['array-shuffle', 'shuffle-array', 'z-shuffle pure=false'] }
];
